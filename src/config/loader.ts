...
import { ConfigError, PathResolutionError } from "../types/errors.js";

const LOG_LEVEL_SET = new Set(LOG_LEVELS);
type DirectoryLabel = "base directory" | "project directory" | "logs directory";

/**
 * Load configuration by combining CLI parameters, environment variables, and defaults.
 */
export const loadConfig = async (
  ...
  // Load environment files in precedence order (lowest first)
...
const normalizeLogLevel = (value: string): string => {
